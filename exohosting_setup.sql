...
('Tehla Porotherm 30 Profi', 'Brúsená tehla pre obvodové murivo s vysokou tepelnou izoláciou.', 2.45, 'Hrubá stavba', 'TEH-P30', 1200, '', 'material', 'ks'),
('Tvárnica DT 20 (50x20x25)', 'Betónová tvárnica pre stratené debnenie základov.', 1.85, 'Hrubá stavba', 'TVAR-DT20', 850, '', 'material', 'ks'),
('Cement CEM II 32.5 R (25kg)', 'Portlandský cement pre bežné betónárske práce.', 4.20, 'Hrubá stavba', 'CEM-25KG', 200, '', 'material', 'balenie'),
('Murovacia malta Profi (25kg)', 'Suchá zmes pre murovanie z tehál i tvárnic.', 4.80, 'Hrubá stavba', 'MAL-25KG', 300, '', 'material', 'balenie'),
('Sádrokartón GKB 12.5mm', 'Štandardná sádrokartónová doska Rigips.', 8.90, 'Suchá výstavba', 'SDK-GKB12', 150, '', 'material', 'ks'),
('Sádrokartón RBI (Vodeodolný)', 'Zelená doska do kúpeľní.', 12.50, 'Suchá výstavba', 'SDK-RBI12', 80, '', 'material', 'ks'),
('CD Profil 3m', 'Oceľový profil pre sádrokartónové podhľady.', 3.20, 'Suchá výstavba', 'PRO-CD3', 200, '', 'material', 'ks'),
('Polystyrén EPS 70 (100mm)', 'Fasádny polystyrén pre zateplenie.', 9.50, 'Izolácie', 'ISO-EPS70', 300, '', 'material', 'm2'),
('Lepidlo na zateplenie (25kg)', 'Lepiaca malta pre EPS.', 5.90, 'Izolácie', 'LEP-25KG', 250, '', 'material', 'balenie'),
('Škridla Bramac Classic', 'Strešná krytina – Čierna.', 1.45, 'Strechy', 'STR-BRC', 2000, '', 'material', 'ks'),
('Zámková dlažba 6cm Sivá', 'Dlažba pre chodníky.', 14.90, 'Záhrada', 'DLZ-HO6', 50, '', 'material', 'm2'),
('Kladivo 500g Stanley', 'Kvalitné tesárske kladivo s ergonomickou rúčkou.', 14.50, 'Ručné náradie', 'NAR-KLAD', 15, '', 'tool', 'ks'),
('Uhlová brúska Bosch GWS', '125mm elektrická brúska pre profesionálov.', 89.00, 'Elektrické náradie', 'NAR-BRUS', 8, '', 'tool', 'ks'),
('Kuprikol 50 (100g)', 'Tradičný mednatý prípravok vo forme zmáčateľného prášku na ochranu rastlín.', 4.80, 'Postreky', 'AGR-POS-KUP', 50, '', 'agriculture', 'balenie'),
('Bofix (100ml)', 'Selektívny systémový herbicíd na ničenie dvojklíčnolistových burín.', 8.50, 'Postreky', 'AGR-POS-BOF', 30, '', 'agriculture', 'balenie'),
('Záhradné hrable kovové (14 zubov)', 'Kvalitné kovové hrable s drevenou násadou.', 12.90, 'Hrable a náradie', 'AGR-NAR-HRA', 25, '', 'agriculture', 'ks'),
('Záhradná lopata Fiskars', 'Ergonomická špicatá lopata s kovovou násadou.', 24.50, 'Hrable a náradie', 'AGR-NAR-LOP', 15, '', 'agriculture', 'ks'),
('Parozábrana (75m2)', 'Hliníková reflexná parotesná fólia pre podkrovia.', 38.90, 'Izolácie', 'ISO-PARO', 40, '', 'material', 'rolka'),
('Geotextília 200g (m2)', 'Netkaná geotextília pod drenáže a zámkovú dlažbu.', 0.85, 'Izolácie', 'GEO-200', 500, '', 'material', 'm2'),
('Betón B20 (25kg)', 'Suchá betónová zmes pre potery a základy.', 3.90, 'Hrubá stavba', 'BET-B20', 400, '', 'material', 'balenie'),
('UD Profil 3m', 'Obvodový oceľový profil pre sadrokartón.', 2.60, 'Suchá výstavba', 'PRO-UD3', 180, '', 'material', 'ks'),
('Strešný asfaltový pás', 'Hydroizolačný natavovací pás V60 S35.', 29.90, 'Strechy', 'STR-ASF', 60, '', 'material', 'rolka')
