          ...
          <ul className="space-y-4">
            <li className="flex items-start gap-3 mt-1">
              ...
              <div className="text-xs leading-none">
                <strong className="text-white block mb-1">{settings.billing_name}</strong>
                {settings.contact_address}
              </div>
            </li>
            <li className="flex items-center gap-3">
              <Phone size={16} className="text-primary shrink-0" />
              <a href={`tel:${settings.contact_phone}`} className="text-xs hover:text-white transition-colors">{settings.contact_phone}</a>
            </li>
            <li className="flex items-center gap-3">
              <Mail size={16} className="text-primary shrink-0" />
              <a href={`mailto:${settings.contact_email || 'kubik@stavivalubela.sk'}`} className="text-xs hover:text-white transition-colors">
