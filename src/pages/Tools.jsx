  ...
  const fetchTools = async () => {
    try {
      ...
      if (data && Array.isArray(data)) {
        ...
        setProducts(data.filter(p => (p.type === 'tool' || toolCategories.includes(p.category)) && p.category !== 'Farby a laky'))
      }
    } catch (error) {
      ...
      <section className="mb-12 sm:mb-16">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 md:gap-12">
          <div className="max-w-3xl">
            <h1 className="text-3xl sm:text-5xl md:text-7xl font-black tracking-tighter mb-4 sm:mb-6 uppercase break-words">Náradie</h1>
          ...
          <div className="flex flex-col gap-6 w-full md:w-auto">
            <div className="relative group">
              <input
                ...
                className="w-full md:w-80 bg-white py-5 pr-5 !pl-14 text-sm font-bold uppercase tracking-wider border-b-2 border-outline/10 focus:border-primary outline-none transition-all"
                value={searchQuery}
