  ...
  const fetchPaints = async () => {
    try {
      ...
      if (data && Array.isArray(data)) {
        setProducts(data.filter(p => p.type === 'paint' || p.category === 'Farby a laky'))
      }
    } catch (error) {
      ...
      <section className="mb-12 sm:mb-16">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 md:gap-12">
          <div className="max-w-3xl">
            <h1 className="text-3xl sm:text-5xl md:text-7xl font-black tracking-tighter mb-4 sm:mb-6 uppercase break-words">Farby / Laky</h1>
