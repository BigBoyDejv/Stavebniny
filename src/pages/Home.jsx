  ...
  return (
    <div className="pt-20">
      ...
      <section className="py-24 max-w-[1440px] mx-auto px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-rows-2 gap-6 h-[700px]">
          <div className="md:col-span-2 md:row-span-2 bg-surface-container-lowest overflow-hidden group cursor-pointer relative">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent flex flex-col justify-end p-8">
              <h3 className="text-white font-headline text-2xl font-bold">Hrubá stavba</h3>
              <p className="text-zinc-200 text-sm mt-2">Tehly, tvárnice, izolácie a ocel.</p>
              <div className="w-12 h-1 bg-primary mt-4 transform origin-left transition-transform group-hover:scale-x-150"></div>
            </div>
          </div>
          <div className="md:col-span-2 bg-surface-container-lowest overflow-hidden group cursor-pointer relative">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent flex flex-col justify-end p-8">
              <h3 className="text-white font-headline text-xl font-bold">Suchá výstavba</h3>
              <p className="text-zinc-200 text-sm mt-2">Sádrokartón a omietky.</p>
            </div>
          </div>
          <div className="bg-surface-container-lowest overflow-hidden group cursor-pointer relative">
